...
export const NewHabit = function() {
   const { goal, setGoal, habit, setHabit, habits, setHabits } = useHabitContext();
   ...
   const handelSubmit = function(e) {
     ...
     setGoal("");
     setHabit("");
     document.getElementById('my_modal_3').close(); // Close modal after submission
     Navigate('/done')
   };
